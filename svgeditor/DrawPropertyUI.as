...
public class DrawPropertyUI extends Sprite {
	...
	private function makeFontUI():void {
		function fontMenu():void {
			...
			m.addItem('Alphav2');
			m.addItem('BLADRMF');
			m.addItem('Cyberverse');
			m.addItem('MayaCulpa');
			m.addItem('NWV');

			m.addItem('OneManArmy');
			m.addItem('PLANM');
			m.addItem('PermanentMarker');
			m.addItem('Planetxv2');
			m.addItem('RapierZero');
			m.addItem('Renegade');
			m.addItem('SFOuterLimits');
			m.addItem('StarWaves');
			m.addItem('StarshipOne');
			m.addItem('Starsteel');
			m.addItem('TOMOPRG');
			...
			m.addItem('pdark');
			m.addItem('robotaur');
			m.addItem('sector_017');
			m.addItem('skirmisher');
			m.addItem('skyhawk');
