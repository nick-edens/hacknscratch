...
public class ImagesPart extends UIPart {
	...
	public function refresh(fromEditor:Boolean = false):void {
		...
		costumeLibraryButton.visible = false;
		costumeLibraryButton.width = 0;
...
//		editor.saveContent();
	...
	protected function savePhotoAsCostume(photo:BitmapData):void {
		...
		if (obj.isStage) { // resize photo to stage
			var scale:Number = 1280 / photo.width;
			var m:Matrix = new Matrix();
			m.scale(scale, scale);
			var scaledPhoto:BitmapData = new BitmapData(1280, 720, true, 0);
