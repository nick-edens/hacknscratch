...
public class TopBarPart extends UIPart {
	...
	protected var stageMenu:IconButton;
	...
	public static function strings():Array {
		if (Scratch.app) {
			...
			Scratch.app.showStageMenu(Menu.dummyButton());
		}
		return ['File', 'Edit', 'Stage', 'Tips', 'Duplicate', 'Delete', 'Grow', 'Shrink', 'Block help', 'Offline Editor'];
	}
	...
	protected function fixLayout():void {
		...
		stageMenu.x = nextX;
		stageMenu.y = buttonY;
		nextX += stageMenu.width + buttonSpace;
	...
	protected function addTextButtons():void {
		...
		addChild(stageMenu = makeMenuButton('Stage', app.showStageMenu, true));
	}
