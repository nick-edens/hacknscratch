...
public class Resources {
	...
	[Embed(source='fonts/8thCargo.ttf', fontName='8thCargo', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font7:Class;
	[Embed(source='fonts/AlienFur.ttf', fontName='AlienFur', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font8:Class;
	[Embed(source='fonts/Alphav2.ttf', fontName='Alphav2', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font9:Class;
	[Embed(source='fonts/BLADRMF_.TTF', fontName='BLADRMF', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font10:Class;
	[Embed(source='fonts/Cyberverse.otf', fontName='Cyberverse', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font11:Class;
	[Embed(source='fonts/MayaCulpa.ttf', fontName='MayaCulpa', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font12:Class;
	[Embed(source='fonts/NWV.TTF', fontName='NWV', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font13:Class;

	[Embed(source='fonts/OneManArmy.ttf', fontName='OneManArmy', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font14:Class;
	[Embed(source='fonts/PLANM.TTF', fontName='PLANM', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font15:Class;
	[Embed(source='fonts/PermanentMarker.ttf', fontName='PermanentMarker', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font16:Class;
	[Embed(source='fonts/Planetxv2.ttf', fontName='Planetxv2', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font17:Class;
	[Embed(source='fonts/RapierZero.otf', fontName='RapierZero', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font18:Class;
	[Embed(source='fonts/Renegade.otf', fontName='Renegade', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font19:Class;
	[Embed(source='fonts/SFOuterLimits.ttf', fontName='SFOuterLimits', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font21:Class;
	[Embed(source='fonts/StarWaves.ttf', fontName='StarWaves', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font22:Class;
	[Embed(source='fonts/StarshipOne.ttf', fontName='StarshipOne', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font23:Class;
	[Embed(source='fonts/Starsteel.ttf', fontName='Starsteel', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font24:Class;
	[Embed(source='fonts/TOMOPRG.TTF', fontName='TOMOPRG', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font25:Class;

	[Embed(source='fonts/TRON.TTF', fontName='TRON', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font26:Class;
	[Embed(source='fonts/Tr2n.ttf', fontName='Tr2n', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font27:Class;
	[Embed(source='fonts/UFONEST.ttf', fontName='UFONEST', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font28:Class;
	[Embed(source='fonts/VIPESRG.TTF', fontName='VIPESRG', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font29:Class;
	[Embed(source='fonts/bigmacca.ttf', fontName='bigmacca', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font30:Class;
	[Embed(source='fonts/mionta.ttf', fontName='mionta', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font31:Class;
	[Embed(source='fonts/pdark.ttf', fontName='pdark', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font32:Class;
	[Embed(source='fonts/robotaur.ttf', fontName='robotaur', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font33:Class;
	[Embed(source='fonts/sector_017.ttf', fontName='sector_017', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font34:Class;
	[Embed(source='fonts/skirmisher.ttf', fontName='skirmisher', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font35:Class;
	[Embed(source='fonts/skyhawk.ttf', fontName='skyhawk', embedAsCFF = 'false', advancedAntiAliasing = 'true')] private static const Font36:Class;
